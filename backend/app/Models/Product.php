...
class Product extends Model
{
    ...
    {
        return 'COALESCE(stock_in,0) - COALESCE(stock_out,0) - COALESCE(reserved_quantity,0) - COALESCE(in_delivery_quantity,0)';
    }

    protected function stockInterne(): Attribute
    {
        return Attribute::make(
            get: fn () => (int) $this->stock_in - (int) $this->stock_out - (int) $this->reserved_quantity - (int) $this->in_delivery_quantity,
        );
    }
