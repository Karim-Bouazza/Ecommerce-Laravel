...
function SidebarTrigger({
  ...
  // The sidebar already has its own close button while expanded, so this
  // trigger only needs to appear (as the reverse "open" icon) once it is
  // collapsed. On mobile there is no in-sidebar close button, so it always shows.
