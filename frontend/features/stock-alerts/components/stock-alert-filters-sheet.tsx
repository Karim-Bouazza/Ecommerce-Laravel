...
export type StockAlertFiltersValue = {
...
const emptyFilters: StockAlertFiltersValue = {}

type StockAlertFiltersSheetProps = {
  value: StockAlertFiltersValue
  onApply: (value: StockAlertFiltersValue) => void
}
...
export function StockAlertFiltersSheet({ value, onApply }: StockAlertFiltersSheetProps) {
  const [open, setOpen] = React.useState(false)
  const [draft, setDraft] = React.useState<StockAlertFiltersValue>(value)
