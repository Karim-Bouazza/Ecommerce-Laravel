...
export function HeroCategoriesPage() {
  ...
  return (
    <Card className="max-w-2xl">
      <CardHeader>
        <CardTitle>Catégories mises en avant (accueil)</CardTitle>
        <CardDescription>
          Choisissez les catégories affichées dans le bloc d&apos;accueil de la boutique et leur
          image. Le nombre de cartes affichées suit exactement le nombre de catégories
          sélectionnées ici, et le nombre de produits est calculé automatiquement.
        </CardDescription>
      </CardHeader>
